...
export const envs={
    PORT: envVars.PORT,
    ProductsMicroservicesHost: envVars.PRODUCT_MICROSERVICE_HOST,
    ProductsMicroservicesPort: envVars.PRODUCT_MICROSERVICE_PORT, 
    OrdersMicroservicesHost: envVars.ORDER_MICROSERVICE_HOST,
    OrdersMicroservicesPort: envVars.ORDER_MICROSERVICE_PORT
}